...
interface AddEstablishmentProps {
  ...
  onAdd: (
    est: EstablishmentFormData & { polygon?: PolygonData | null }
  ) => Promise<void>;
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Fill in the establishment details and define its boundaries
              </p>
            </div>
                ...
                <div className="space-y-4 p-4 bg-muted/50 rounded-lg">
                  <div className="flex items-start justify-between mb-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Enter the establishment's basic details
                      </p>
                    </div>
                    <Button
                      type="button"
                  ...
                  <div className="p-3 bg-background rounded border">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        {polygon ? "Edit Boundary" : "Draw Boundary"}
                      </Button>
                    </div>
                  </div>
                </div>
      ...
      <AlertDialog open={showClearDialog} onOpenChange={setShowClearDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to clear the form? This will also remove any
              drawn polygon.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to cancel? All unsaved changes including any
              drawn polygon will be lost.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
