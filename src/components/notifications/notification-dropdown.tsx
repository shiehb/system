...
const initialNotifications = [
  ...
  },
  {
    ...
    description: "Inspection for Sunrise Manufacturing scheduled for tomorrow at 10:00 AM.",
    time: "Yesterday",
    read: false,
    type: "warning",
  },
  {
    ...
    description: "Harbor Industrial Complex has a compliance issue that needs attention.",
    time: "2 days ago",
    read: true,
    type: "error",
  },
    ...
    setNotifications(notifications.map((n) => ({ ...n, read: true })))
      toast.success(
        <div>
          ...
          <p className="text-sm text-muted-foreground">All notifications have been marked as read.</p>
        </div>
      )
  }
  ...
  const clearAll = () => {
    ...
    toast.success(
      <div>
        ...
        <p className="text-sm text-muted-foreground">All notifications have been cleared.</p>
      </div>
    )
    setOpen(false)
  }
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const newNotification = {
        ...
        description: "This is a simulated new notification for demonstration purposes.",
        time: "Just now",
        read: false,
        type: "info" as const,
      }
    ...
    <>
      <DropdownMenu open={open} onOpenChange={setOpen}>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="icon" className="relative border-2 rounded-full">
